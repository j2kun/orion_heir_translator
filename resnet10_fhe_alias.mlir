...
module attributes {ckks.schemeParam = #ckks.scheme_param<logN = 16, Q = [36028797019488257, 1099512938497, 1099510054913, 1099507695617, 1099515691009, 1099516870657, 1099506515969, 1099504549889, 1099503894529, 1099503370241, 1099502714881], P = [1099511627776], logDefaultScale = 40>} {
  func.func @resnet10(%ct: !ct_L10, %arg0: tensor<198x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "conv1", orion.layer_role = "weights"}, %arg1: tensor<288x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.0.0.conv1", orion.layer_role = "weights"}, %arg2: tensor<288x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.0.0.conv2", orion.layer_role = "weights"}, %arg3: tensor<256x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.1.0.conv1", orion.layer_role = "weights"}, %arg4: tensor<784x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.1.0.conv2", orion.layer_role = "weights"}, %arg5: tensor<64x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.1.0.shortcut.0", orion.layer_role = "weights"}, %arg6: tensor<648x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.2.0.conv1", orion.layer_role = "weights"}, %arg7: tensor<1800x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.2.0.conv2", orion.layer_role = "weights"}, %arg8: tensor<200x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "layers.2.0.shortcut.0", orion.layer_role = "weights"}, %arg9: tensor<89x!pt> {orion.block_col = 0 : i64, orion.block_row = 0 : i64, orion.layer_name = "linear", orion.layer_role = "weights"}, %pt: !pt {orion.layer_name = "linear", orion.layer_role = "bias"}) -> !ct_L10 {
    %ct_0 = orion.linear_transform %ct, %arg0 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 198 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10, tensor<198x!pt>) -> !ct_L10
    ...
    %ct_13 = orion.linear_transform %ct_12, %arg1 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 288 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10_2, tensor<288x!pt>) -> !ct_L10_2
    ...
    %ct_26 = orion.linear_transform %ct_25, %arg2 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 288 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10_2, tensor<288x!pt>) -> !ct_L10_2
    ...
    %ct_39 = orion.linear_transform %ct_38, %arg3 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 256 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10, tensor<256x!pt>) -> !ct_L10
    ...
    %ct_54 = orion.linear_transform %ct_53, %arg4 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 784 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10_2, tensor<784x!pt>) -> !ct_L10_2
    ...
    %ct_69 = orion.linear_transform %ct_68, %arg5 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 64 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10, tensor<64x!pt>) -> !ct_L10
    %ct_70 = ckks.rotate %ct_69 {offset = 16384 : i32} : !ct_L10
    %ct_71 = ckks.add %ct_70, %ct_69 : (!ct_L10, !ct_L10) -> !ct_L10
    %ct_72 = orion.linear_transform %ct_71, %arg6 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 648 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10, tensor<648x!pt>) -> !ct_L10
    ...
    %ct_89 = orion.linear_transform %ct_88, %arg7 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 1800 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10_2, tensor<1800x!pt>) -> !ct_L10_2
    ...
    %ct_106 = orion.linear_transform %ct_105, %arg8 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 200 : i32, orion_level = 2 : i32, slots = 32768 : i32} : (!ct_L10, tensor<200x!pt>) -> !ct_L10
    ...
    %ct_111 = orion.linear_transform %ct_110, %arg9 {block_col = 0 : i32, block_row = 0 : i32, bsgs_ratio = 2.000000e+00 : f64, diagonal_count = 89 : i32, orion_level = 1 : i32, slots = 32768 : i32} : (!ct_L10, tensor<89x!pt>) -> !ct_L10

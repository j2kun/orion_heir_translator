...
class TypeBuilder:
    ...
    def create_plaintext_type_for_tensor(self, tensor_type: TensorType):
        ...
        from ..dialects.lwe import (
            LWEPlaintextType, PlaintextSpaceAttr, ApplicationDataAttr,
    ...
    def get_scaling_factor(self, type_obj: Any) -> int:
        ...
        from ..dialects.lwe import (
            LWEPlaintextType, LWECiphertextType, 
    ...
    def create_rescaled_type(self, input_type: Any, target_scale: int) -> Any:
        ...
        from ..dialects.lwe import (
            LWECiphertextType, PlaintextSpaceAttr, CiphertextSpaceAttr, ModulusChainAttr,
            InverseCanonicalEncodingAttr, FullCRTPackingEncodingAttr
        )
        from ..dialects.mod_arith import ModArithType
        from ..dialects.rns import RNSType
    ...
    def create_plaintext_type_with_scale(self, log_scale: int = None, match_ciphertext_type: Any = None):
        ...
        from ..dialects.lwe import (
            LWEPlaintextType, PlaintextSpaceAttr,
            InverseCanonicalEncodingAttr
        )
        from xdsl.dialects.builtin import IntegerAttr, IntegerType
    ...
    def infer_result_type(self, op_type: str, lhs_type: Any, rhs_type: Any) -> Any:
        ...
        from ..dialects.lwe import (
            LWEPlaintextType, LWECiphertextType, PlaintextSpaceAttr, CiphertextSpaceAttr,
            InverseCanonicalEncodingAttr, FullCRTPackingEncodingAttr
        )
        from xdsl.dialects.builtin import IntegerAttr, IntegerType
    ...
    def infer_result_type_with_relinearization(self, op_type: str, lhs_type: Any, rhs_type: Any) -> Any:
        ...
        from ..dialects.lwe import LWECiphertextType, CiphertextSpaceAttr, PlaintextSpaceAttr, InverseCanonicalEncodingAttr
        from xdsl.dialects.builtin import IntegerAttr, IntegerType, StringAttr
    ...
    def create_ciphertext_type_with_updated_scale(self, input_type: Any, new_scale: int) -> Any:
        ...
        from ..dialects.lwe import (
            LWECiphertextType, PlaintextSpaceAttr, 
            InverseCanonicalEncodingAttr, FullCRTPackingEncodingAttr
        )
        from xdsl.dialects.builtin import IntegerAttr, IntegerType
